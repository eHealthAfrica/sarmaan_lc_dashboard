...
def clean(row):
    ...
    return {
        ...
        "fieldCoord":    1 if "fci" in activity.split() else 0,
        "supervision":   1 if "sqa" in activity.split() else 0,
        "dataMonitor":   1 if "dmr" in activity.split() else 0,
        "stakeholder":   1 if "stk" in activity.split() else 0,
        "teamMgmt":      1 if "tmg" in activity.split() else 0,
        "problemSolving":1 if "pse" in activity.split() else 0,
        "transit":       1 if "trs" in activity.split() else 0,
